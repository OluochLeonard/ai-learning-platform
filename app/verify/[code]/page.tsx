...
export default async function VerifyPage({
  ...
  return (
    <div className="mx-auto flex min-h-screen w-full max-w-md flex-col items-center justify-center px-5 py-10">
      ...
      {cert ? (
        <div className="mt-8 w-full rounded-2xl border-2 border-green-500 bg-white p-6 text-center">
        ...
        <div className="mt-8 w-full rounded-2xl border-2 border-red-400 bg-white p-6 text-center">
          <p className="text-4xl">❌</p>
          <h1 className="mt-3 text-xl font-bold text-zinc-900">
